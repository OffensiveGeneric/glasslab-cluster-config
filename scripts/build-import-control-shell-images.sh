...
INGRESS_IMAGE="${GLASSLAB_RESEARCH_INGRESS_IMAGE_REF:-ghcr.io/ccny-glasslab/glasslab-research-ingress:0.1.1}"
ROUTER_IMAGE="${GLASSLAB_RESEARCH_COMMAND_ROUTER_IMAGE_REF:-ghcr.io/ccny-glasslab/glasslab-research-command-router:0.1.8-local}"
GATEWAY_IMAGE="${GLASSLAB_WHATSAPP_GATEWAY_IMAGE_REF:-ghcr.io/ccny-glasslab/glasslab-whatsapp-gateway:0.1.4-local}"
