...
2. Remove the temporary debug SSH/password allowances from the PXE autoinstall profiles by following `docs/glasslab-v2/runbooks/purge-temporary-provisioning-debug.md` once the remaining password-dependent helpers are replaced.
