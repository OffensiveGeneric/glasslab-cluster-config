...
- `workflow-api` is now targeted at `ghcr.io/offensivegeneric/glasslab-workflow-api:0.1.25-local`.
...
- `gpu-neural-net-experiment` runs use `ghcr.io/offensivegeneric/glasslab-gpu-experiment-runner:0.1.1`.
