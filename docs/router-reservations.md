...
| --- | --- | --- | --- | --- |
| `192.168.1.44` | `18:66:da:16:25:9d` | `glasslab-PXE-01` | active | internal provisioner, Ansible control host, kubectl workstation |
...
| `192.168.1.51` | `18:66:da:24:44:de` | `node04` | active | Kubernetes worker, GeForce GTX 1060 6GB enabled |
